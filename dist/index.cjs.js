...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#161616", backgroundDisabled: "#2a2a2a", contrast: "#FFFFFF", invertedContrast: "#1a1a1a", input: "#2a2a2a", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", tertiary: "#1a1a1a", text: "#fff", textDisabled: "#716a61", textSubtle: "#fff", activeButton: "#397f49", borderColor: "#2a2a2a", card: "#3B3B3B", nav: "rgba(22,22,22,0.7)", priceBackground: "#2a2a2a", priceBorder: "#2B373D", gradients: {
