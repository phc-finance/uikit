...
var Icon$K = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 22 18" }, props),
        React.createElement("path", { d: "M21 1.00904C20 1.49904 19.02 1.69804 18 1.99904C16.879 0.734037 15.217 0.664037 13.62 1.26204C12.023 1.86004 10.977 3.32204 11 4.99904V5.99904C7.755 6.08204 4.865 4.60404 3 1.99904C3 1.99904 -1.182 9.43204 7 12.999C5.128 14.246 3.261 15.087 1 14.999C4.308 16.802 7.913 17.422 11.034 16.516C14.614 15.476 17.556 12.793 18.685 8.77404C19.0218 7.55171 19.189 6.2889 19.182 5.02104C19.18 4.77204 20.692 2.24904 21 1.00804V1.00904Z", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round", fill: "transparent" })));
};

var Icon$L = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 18" }, props),
        React.createElement("path", { d: "M13 7L9 11L15 17L19 1L1 8L5 10L7 16L10 12", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round", fill: "transparent" })));
};

var Icon$M = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M16 4H8C5.79086 4 4 5.79086 4 8V16C4 18.2091 5.79086 20 8 20H16C18.2091 20 20 18.2091 20 16V8C20 5.79086 18.2091 4 16 4Z", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", fill: "transparent" }),
        React.createElement("path", { d: "M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", fill: "transparent" }),
        React.createElement("path", { d: "M16.5 7.5V7.501", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })));
};

var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M12 8C14.648 8 17.028 8.826 18.675 10.14C19.2384 9.9425 19.8539 9.95316 20.4102 10.1701C20.9664 10.3869 21.4267 10.7958 21.7077 11.3225C21.9888 11.8493 22.072 12.4592 21.9424 13.042C21.8127 13.6248 21.4788 14.142 21.001 14.5C21.001 18.09 16.971 21 12.001 21C7.126 21 3.156 18.2 3.001 14.706L2.001 14.5C1.52319 14.142 1.18927 13.6248 1.05964 13.042C0.930012 12.4592 1.01324 11.8493 1.29426 11.3225C1.57529 10.7958 2.03555 10.3869 2.59181 10.1701C3.14806 9.95316 3.76357 9.9425 4.327 10.14C5.973 8.827 8.353 8 11.001 8H12Z", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", fill: "transparent" }),
        React.createElement("path", { d: "M12 8L13 3L19 4", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { d: "M19 5C19.5523 5 20 4.55228 20 4C20 3.44772 19.5523 3 19 3C18.4477 3 18 3.44772 18 4C18 4.55228 18.4477 5 19 5Z", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { d: "M9 13.5C9.27614 13.5 9.5 13.2761 9.5 13C9.5 12.7239 9.27614 12.5 9 12.5C8.72386 12.5 8.5 12.7239 8.5 13C8.5 13.2761 8.72386 13.5 9 13.5Z", fill: "black", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { d: "M15 13.5C15.2761 13.5 15.5 13.2761 15.5 13C15.5 12.7239 15.2761 12.5 15 12.5C14.7239 12.5 14.5 12.7239 14.5 13C14.5 13.2761 14.7239 13.5 15 13.5Z", fill: "black", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
        React.createElement("path", { d: "M10 17C10.667 17.333 11.333 17.5 12 17.5C12.667 17.5 13.333 17.333 14 17", stroke: "white", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })));
};
...
var RotatingPancakeIcon = styled(Icon$P)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$O)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        isMobile ? (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$T, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$S, { width: "24px", color: "textSubtle" })))) : (React.createElement(StyledBlank, null)),
...
var links = [
    ...
    },
    {
        ...
        icon: "ShieldIcon",
        href: "https://twitter.com/CoinPhc/status/1367218225310818308",
        target: "_blank",
    },
    {
        label: "Bush",
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Blog",
                href: "https://phcfinance.medium.com/",
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/PHC_coin",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/CoinPhc",
    },
];
var MENU_HEIGHT = 100;
        ...
        if (entry.items) {
            ...
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href, target: item.target, style: { whiteSpace: 'nowrap' } }, item.label))); })));
        }
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, null,
        React.createElement(Icon$x, { width: "24px", mr: "12px" }),
        React.createElement(Text, { color: "text", bold: false }, "$" + cakePriceUsd.toFixed(7)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#161616", backgroundDisabled: "#2a2a2a", contrast: "#FFFFFF", invertedContrast: "#1a1a1a", input: "#2a2a2a", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", tertiary: "#1a1a1a", text: "#fff", textDisabled: "#716a61", textSubtle: "#fff", activeButton: "#397f49", borderColor: "#2a2a2a", card: "#303030", nav: "rgba(22,22,22,0.7)", priceBackground: "#2a2a2a", priceBorder: "#2B373D", gradients: {
